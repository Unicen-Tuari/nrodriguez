{include file="header.tpl"}
      ...
      <form class="col-sm-6 col-xs-12" action="insertarProducto" method="post">
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[0]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[1]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[2]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[3]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[4]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[5]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[6]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[7]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[8]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[9]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[10]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[11]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[12]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[13]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[14]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[15]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[16]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[17]}</span>{/if}
      </div>
    </div>
    <div class="form-group row">
      ...
      <div class="col-sm-10">
        ...
        {if $errores}<span class="label label-danger">{$errores[18]}</span>{/if}
      </div>
    </div>
  ...
  {if !$errores}<span class="label label-success">Se inserto con exito</span>{/if}
    </div> <!--/..col-lg-12-->
