<?php
  class configApp{
    ...
    public static $ACTION_VIEW_LOGIN = 'mostrarLogin';
    ...
    public static $RESOURCE_LOGOUT = 'logout';
    public static $RESOURCE_PROD = 'producto';
    public static $RESOURCE_CONTACT = 'contacto';
    public static $RESOURCE_CATEGORY = 'categoria';
